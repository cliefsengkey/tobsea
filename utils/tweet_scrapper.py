...
consumer_key = "CHANGE WITH YOU CONSUMER KEY FROM TWITTER API"
consumer_secret = "YOUR TWITTER API CONSUMER SECRET"
access_key = "YOUR TWITTER API ACCESS KEY"
access_secret = "YOUR TWITER API ACCESS SECRET"
		...
		try:
			...
			for tweet in all_tweets:
				if re.search(r'(?=.*#\b)', tweet[2]):
					print extract_hashtags(tweet[2])
					hashtags = "\n".join(extract_hashtags(tweet[2]))	
...
if __name__ == '__main__':
	# new_dataset_2018 = ['FionaMcleodHill','Will_Tanner','salisburybid','CoachKyleDudley','Kidsebooks']
	# new_dataset_2018 = ['Will_Tanner','salisburybid','CoachKyleDudley','Kidsebooks']
	new_dataset_2018 = ['salisburybid','CoachKyleDudley','Kidsebooks']
	# scrapTweets('cliefsengkey')
	# userdataset2 = ['whussupfoot','valmaidearden','dVbryann','Todd_The_Fox','daniellejade198']
	for user in new_dataset_2018:
		print user
		scrapTweets(user)
